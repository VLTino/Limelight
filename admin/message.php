...
$id = $_GET["id"];
$rdmessage = query("SELECT * FROM `message` WHERE `id`= '$id' ")[0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    padding:5px; border-radius:10px; word-break: break-word;" class="col-lg-auto" >
                            <Form method="post">
                                <input type="hidden" value="<?php echo $rdmessage["id"] ?>" name="id">
                                <input type="hidden" value="<?php echo $rdmessage["name"] ?>" name="name">
                                <input type="hidden" value="<?php echo $rdmessage["email"] ?>" name="email">
                                <input type="hidden" value="<?php echo $rdmessage["phonenbr"] ?>" name="phone">
                                <input type="hidden" value="<?php echo $rdmessage["message"] ?>" name="message">
                                <h5>Name :
                                    <?php echo $rdmessage["name"] ?>
                                </h5>
                                <h5>Email :
                                    <?php echo $rdmessage["email"] ?>
                                </h5>
                                <h5>Phone :
                                    <?php echo $rdmessage["phonenbr"] ?>
                                </h5>
                                <h5>Message:
                                    <?php echo $rdmessage["message"] ?>
                                </h5>
                                <button type="submit" name="read"
                                    style="background-color:cyan; border-radius:10px; ">Done</button>
                            </Form>
