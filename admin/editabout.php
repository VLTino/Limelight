...
$abt = query("SELECT * FROM `abouthm` WHERE `id` =  '$id'")[0];


if(isset($_POST["sbmabout"])){
    if(editabout($_POST) > 0){
        echo "<script>
        alert('data  berhasil diedit');
        document.location.href = 'abouthm.php';
        </script>";
    }else {
        echo "<script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden"value="<?php echo $abt ["id"]; ?>" name="id">
                        <div class="form-group">
                            Teks <br>
                            <textarea class="form-control" name="teks" ><?php echo $abt["teks"]; ?></textarea>
                        </div>
                        <div class="form-group">
                            Image <br>
                            <img src="img/<?php echo $abt["gambar"]; ?>" alt="" srcset="" style="width:300px;" class="img-fluid">
                            <h5 style="color:red;">WAJIB DI ISI!</h5>
                            <input type="file" name="gambar" value="" class="form-control" required>  
                        </div>
                        <div class="form-group">
                            Readmore <br>
                            <input type="text" class="form-control" name="readmore" value="<?php echo $abt["readmore"]; ?>"><br><br>
                        </div>
                        <input type="Submit" class="btn btn-primary btn-user btn-block"style="width:100px;" name="sbmabout"> 
                        <a href="abouthm.php" class="btn btn-primary btn-danger btn-block" style="width:100px;">Cancel</a>
