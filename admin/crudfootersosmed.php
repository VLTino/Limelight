...
if (isset($_POST["submit"])) {
    if ( sosmed($_POST) > 0) {
        ...
        document.location.href = 'crudfootersosmed.php';
        </script>";
    } else {
        echo "<script>
...
<!-- Nav item home pages -->
 ...
 <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">CRUD Footer</p>

                      <form action="" method="post">
                        <div class="form-group">
                            Facebook <br>
                            <input type="text" class="form-control" name="facebook"
                                value="<?php echo $sosmed["facebook"]; ?>">
                        </div>
                        <div class="form-group">
                            Twitter <br>
                            <input type="text" class="form-control" name="twitter"
                                value="<?php echo $sosmed["twitter"]; ?>">
                        </div>
                        <div class="form-group">
                            Linkedin <br>
                            <input type="text" class="form-control" name="linkedin"
                                value="<?php echo $sosmed["linkedin"]; ?>">
                        </div>
                        <div class="form-group">
                            Instagram <br>
                            <input type="text" class="form-control" name="instagram"
                                value="<?php echo $sosmed["instagram"]; ?>">
                        </div>
                        <div class="form-group">
                            Paragraft under social media <br>
                            <textarea class="form-control" name="teks"><?php echo $sosmed["teks"]; ?></textarea>
                        </div>
