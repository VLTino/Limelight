...
<!-- Nav item home pages -->
 ...
 <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Header Home</p>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                        Text <br>
                        <textarea class="form-control" name="teks" placeholder="text" required></textarea>
                        </div>
                        <div class="form-group">
                        Read More <br>
                        <input type="text" class="form-control" name="readmore" placeholder="link" required>
                                </div>
                        Status <br>
                        ...
                        <input type="Submit" style="color: white; background-color:blue; border-radius: 10px;"
                            name="sbmheader">
