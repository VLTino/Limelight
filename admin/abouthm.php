...
$abt = mysqli_query($conn, "SELECT * FROM `abouthm`");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php while ($row = mysqli_fetch_assoc($abt)): ?>
                        Paragraft <br>
                        <p style="font-weight:bold; color:black;">
                            <?php echo $row["teks"]; ?>
                        </p><br>
                        Image <br>
                       <img src="img/<?php echo $row["gambar"]; ?>" alt="" srcset="" style="width:300px;" class="img-fluid"><br>
                       Readmore <br>
                       <p style="font-weight:bold; color:black;word-break:break-all;">
                           <?php echo $row["readmore"]; ?>
                       </p><br>
                       <a href="editabout.php?id=<?php echo $row ["id"]; ?>" class="btn btn-primary btn-user btn-block" style="width:100px;">Edit</a>
                   <?php endwhile; ?>
