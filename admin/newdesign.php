...
$gbr = mysqli_query($conn, "select * from `newdesignimg` ;");
$result = mysqli_query($conn, "select * from `newdesign` ;");
$message = mysqli_query($conn, "SELECT * FROM `message` ");
if(isset($_POST["sbmgambar"])) {
    if (imgnewdesign($_POST) > 0){
      echo "<script>
      alert('data gambar telah diganti')
      document.location.href = 'newdesign.php';
      </script>";
    }else {
      echo "<script>
      alert('data gambar gagaldiganti')
      document.location.href = 'newdesign.php';
      </script>";
    }
  }
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">New Design</h1>
                        <a href="#"></i> </a>
                    </div>
                    <h5 style="color:red;">Hanya boleh ada 1 status active (kosong berarti relative)</h5>
                    ...
                    <div class="table-responsive">
                        <table border="" cellpadding="10" >
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                <tr>
                                    <td>
                                        <a href="editnewdesign.php?id=<?php echo $row["id"]; ?>"
                                            class="btn btn-primary btn-user btn-block">Edit</a>
                                        <a href="deletenewdesign.php?id=<?php echo $row["id"]; ?>"
                                            class="btn btn-primary btn-danger btn-block">Delete</a>
                                    </td>
                                    <td>
                                        <?php echo $row["header"]; ?>
                                    </td>
                    ...
                    <a href="crudnewdesign.php" class="btn btn-primary btn-user btn-sm"
                        >Insert</a><br><br>
                    ...
                    <table>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($gbr)): ?>
                            <tr>
                                <td>
                                    <img src="img/<?php echo $row["gambar"]; ?>" alt="aduh" class="img-fluid" style="width:500px">
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </table>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="Submit" class="btn btn-primary btn-user btn-block" style="width:100px"
                            name="sbmgambar">
