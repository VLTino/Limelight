...
$txtglr = query("SELECT * FROM `galeryteks`");
$galery = mysqli_query($conn,"SELECT *FROM `galeryimg`");
$message = mysqli_query($conn, "SELECT * FROM `message` ");

if (isset($_POST["submit"])) {
    if (plusglr($_POST) > 0) {
        echo "<script>
      alert('data gambar telah ditambahkan')
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">CRUD Galery</h1>
                        <a href="#"></i> </a>
                    </div>
...
<div class="row">
    ...
    <?php foreach($txtglr as $txt):?>
        <div class="col-lg-10" style="border:2px solid black;border-radius:5px;padding:5px;word-break:break-all;">
            <h5>Header</h5>
            <p><?php echo $txt["header"]; ?></p>
            <h5>Teks</h5>
            <p><?php echo $txt["teks"]; ?></p>
            <a href="edittexglr.php?id=<?php echo $txt["id"]; ?>" class="btn btn-primary btn-user btn-block"style="width:100px; ">Edit</a>
        </div>
<?php endforeach; ?>
                        ...
                        <div class="col-lg-12" style="margin-bottom:10px;">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary btn-user btn-block"
                                    style="width:80px; ">Tambah</button>
                            </form>
                        </div>


                        <div class="col-lg-12" style="border:3px solid black;border-radius:10px;text-align:center; ">
                            <h4>Gambar</h4>
                        </div>

                        <?php while ($row = mysqli_fetch_assoc($galery)) :?>
                        <div class="col-lg-4"
                            style=" border:2px solid black;word-break:break-all; margin-top:1px; padding:3px; position:relative;">
                            <img src="img/<?php echo $row["gambar"] ;?>" alt="" srcset="" style="width:100%;" class="img-fluid">
                            <a href="deleteglr.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary btn-danger btn-block"
                                style="width:100px; ">Delete</a>
                                <a href="editglr.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary btn-user btn-block"
