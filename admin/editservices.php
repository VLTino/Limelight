...
$services = query("SELECT * FROM `services` WHERE `id` =  '$id'")[0];

$message = mysqli_query($conn, "SELECT * FROM `message` ");
if(isset($_POST["sbmsrvc"])){
    if( editsrvc($_POST) > 0){
        echo "<script>
        alert('data  berhasil diedit');
        document.location.href = 'servicespage.php';
        </script>";
    }else {
        echo "<script>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">CRUD About</p>

                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden"value="<?php echo $services ["id"]; ?>" name="id">
                        <div class="form-group">
                            Header <br>
                            <input type="text" name="header" class="form-control" value="<?php echo $services ["header"]; ?>">
                        </div>
                        <div class="form-group">
                        Teks <br>
                        <textarea  class="form-control" name="teks" ><?php echo $services["teks"]; ?></textarea><br>
                                </div>
                        <div class="form-group">
                        Image <br>
                        <img src="img/<?php echo $services["gambar"]; ?>" alt="" srcset="" style="width:300px;"> <br>
                        <h5 style="color:red;">WAJIB DI ISI!</h5> <br>
                        <input type="file" name="gambar" class="form-control" value="" required> <br> <br>
                                </div>
                        
                        <input type="Submit" class="btn btn-primary btn-user btn-block"style="width:100px;" name="sbmsrvc"> 
                        <a href="servicespage.php" class="btn btn-primary btn-danger btn-block" style="width:100px;">Cancel</a>
