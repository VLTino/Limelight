...
<!-- Nav item home pages -->
 ...
 <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Testimonial</p>
                      ...
                      <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                        Text 1 <br>
                       <textarea class="form-control" name="teks1" required></textarea>
                                </div>
                       Img 1 <br>
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="header2" required>
                                ...
                                <div class="form-group">
                        Text 2 <br>
                       <textarea class="form-control" name="teks2" required></textarea>
                                </div>
                       Img 2 <br>
                       ...
                       <input type="Submit" class="btn-user btn-sm btn-primary"name="sbmtesti"> 
