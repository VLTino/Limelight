...
$hdr = query("SELECT * FROM `home` WHERE `id` =  '$id'")[0];


if (isset($_POST["sbmheader"])) {
    if ( hdredit($_POST) > 0) {
        echo "<script>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Edit Header Home</p>

                    <form action="" method="post">
                        <input type="hidden" name="id" value="<?php echo $hdr["id"]; ?>">
                        <div class="form-group">
                            Header Text <br>
                            <input type="text" class="form-control"  name="header" required
                                value="<?php echo $hdr["header"]; ?>">
                        </div>
                        <div class="form-group">
                            Text <br>
                            <textarea class="form-control" name="teks"
                                required><?php echo $hdr["teks"]; ?></textarea>
                        </div>
                        <div class="form-group">
                            Read More <br>
                            <input type="text" class="form-control" name="readmore" required
                                value="<?php echo $hdr["readmore"]; ?>">
                        </div>
                        Status <br>
                        <h5 style="color:red;">
                            <?php echo $hdr["status"]; ?>
                        ...
                        <input type="Submit" class="btn btn-primary btn-user btn-block" style="width:100px;"
                            name="sbmheader">
                        <a href="homehdr.php" class="btn btn-primary btn-danger btn-block" style="width:100px;">Cancel</a>
