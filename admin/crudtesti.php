...
<div class="table-responsive">
                    ...
                    <table border="" cellpadding="10" >
                        <tr>
                            ...
                            <th >Teks2</th> 
                            <th >Img2</th> 
                            <th>Status Carousel</th> 
                        </tr>
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                <td>
                                    <a href="edittesti.php?id=<?php echo $row ["id"]; ?>" class="btn btn-primary btn-user btn-block">Edit</a>
                                    <a href="deletetesti.php?id=<?php echo $row ["id"]; ?>" class="btn btn-primary btn-danger btn-block">Delete</a>
                                </td>
                                <td>
                                   <?php echo $row ["h1"]; ?>
                                </td>
                                ...
                                <td>
                                <img src="img/<?php echo $row ["gambar1"]; ?>" alt="" srcset="" style="width:100%;"> 
                                </td>
                                <td>
                                <?php echo $row ["h2"]; ?>
                                </td>
                                ...
                                <td>
                                <img src="img/<?php echo $row ["gambar2"]; ?>" alt="" srcset="" style="width:100%;"> 
                                </td>
                                <td>
                                <?php echo $row ["status"]; ?>
                                </td>
                    ...
                    <a href="plustesti.php" class="btn btn-primary btn-user btn-sm" >Insert</a><br><br>
