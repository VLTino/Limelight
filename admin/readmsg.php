...
$id = $_GET["id"];
$rdmessage = query("SELECT * FROM `messageread` WHERE `id`= '$id' ")[0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    padding:5px; border-radius:10px; word-break: break-word;" class="col-lg-12" >
                                ...
                                <a href="crudcontact.php" class="btn btn-primary btn-danger btn-block" style="width:80px;">Back</a>
