...
$id = $_GET["id"];
$txtglr = query("SELECT * FROM `galeryteks` WHERE `id` = '$id';")[0];
$message = mysqli_query($conn, "SELECT * FROM `message` ");

if(isset($_POST["submit"])){
    if(edittxtglr($_POST) > 0 ){
        echo "<script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Teks Galery</h1>
                        <a href="#"></i> </a>
                    </div>

                    <form action="" method="post">
                        <input type="hidden" name="id" value="<?php echo $txtglr["id"] ?>">
                        Header <br>
                        <input type="text" name="header" value="<?php echo $txtglr["header"]; ?>"><br>
                        Teks <br>
                        <textarea name="teks" id="" cols="30" rows="10"><?php echo $txtglr["teks"]; ?></textarea>
                        <button type="submit" name="submit" class="btn btn-primary btn-user btn-block"style="width:80px; ">Edit</button>
                    </form>
