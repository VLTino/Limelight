...
$rdmessage = mysqli_query($conn, "SELECT * FROM `messageread`");
$mapq = query("SELECT * FROM `contactmap`")[0];

if(isset($_POST["sbmmap"])){
    if( updmap($_POST)){
        echo "<script>
        alert('Map berhasil di ganti')
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">CRUD Contact</p>
                    <div class="row" style="padding-bottom:20px; position:center;">
                    <div class="col-lg-6">
                   <h3> Map Berukuran 600:345 dan style width:100%</h3>
                        <?php echo $mapq ["map"]; ?>
                            </div>
                            <div class="col-lg-5" style="margin:10px;">
                            <h5>Update GMAPS</h5>
                        <form action="" method="post">
                            <textarea name="map" id="" cols="30" rows="10" style="width:100%;"><?php echo $mapq ["map"]; ?></textarea>
                            <button type="submit" class="btn btn-primary btn-success btn-block" style="width:100px;" name="sbmmap">Update</button>
                        </form>
                            </div>
                    </div>
                     <div class="row">
                        <div style="word-break: break-word;" class="col-lg-12">
                            <table border="" cellpadding="10" width="100%">
                                ...
                                <?php while ($row = mysqli_fetch_assoc($rdmessage)): ?>
                                    <tr>
                                        <td>
                                            <p>Name :
                                        ...
                                        <td>
                                            <a href="readmsg.php?id=<?php echo $row["id"]; ?>"
                                                class="btn btn-primary btn-danger btn-block" style="width:80px">Read</a>
                                            <a href="deletemsg.php?id=<?php echo $row["id"]; ?>"
                                                class="btn btn-primary btn-danger btn-block" style="width:80px">Delete</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </table>
