...
$id = $_GET["id"];
$galery = query("SELECT *FROM `galeryimg` WHERE `id` = '$id'")[0];


if(isset($_POST["submit"])){
    if(editgaleryimg($_POST) > 0){
        echo "<script>
      alert('data gambar telah diedit')
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <img src="img/<?php echo $galery["gambar"];?>" alt="" srcset=""><br>
                        <input type="file" name="gambar"><br>
                        <button type="submit"class="btn btn-primary btn-user btn-block"
                                style="width:100px; " name="submit">Edit</button>
                    </form>
