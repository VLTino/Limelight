...
<!-- Nav item home pages -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="newdesign.phpp">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post">
                        Header Text <br>
                        <input type="text" style="width:800px;" name="header"><br><br>
                        Paragraft <br>
                        <textarea style="width:800px; height:70px;" name="teks"></textarea><br><br>
                        Status <br>
                       ...
                       <input type="radio" value="" id="relative" name="status" required><br><br>
                        ...
                        <button type="reset" class="btn btn-primary btn-danger btn-block" style="width:100px">Reset</button>
                    </form>
