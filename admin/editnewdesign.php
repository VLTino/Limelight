...
$id = $_GET["id"];
$dsg = query("SELECT * FROM `newdesign` WHERE `id` =  '$id'")[0];
$message = mysqli_query($conn, "SELECT * FROM `message` ");
if (isset($_POST["sbmhdrdsg"])) {
    if ( editdsg($_POST) > 0) {
        echo "<script>
...
<!-- Nav item home pages -->
 ...
 <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">New Deisgn</h1>
                    <p class="mb-4">CRUD New Design</p>

                    <form action="" method="post">
                    <input type="hidden"value="<?php echo $dsg ["id"]; ?>" name="id">
                        Header Text <br>
                        <input type="text" style="width:800px;" name="header" value="<?php echo $dsg ["header"];  ?>"><br><br>
                        Paragraft <br>
                        <textarea style="width:800px; height:70px;" name="teks"><?php echo $dsg ["teks"]; ?></textarea><br><br>
                        Status <br>
                       ...
                       <input type="radio" value="" id="relative" name="status" required><br><br>
                        <input type="Submit" name="sbmhdrdsg" class="btn btn-primary btn-user btn-block" style="width:100px"> 
                        <a href="newdesign.php" class="btn btn-primary btn-danger btn-block" style="width:100px;">Cancel</a>
                    </form>
