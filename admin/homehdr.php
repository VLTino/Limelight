                ...
                <div class="container-fluid">
                    ...
                    <h5 style="color:red;">Hanya boleh ada 1 status active (kosong berarti relative)</h5>
                     <div class="table-responsive">
                            ...
                            <a href="crudhome.php" class="btn btn-primary btn-user btn-sm"
                                >Insert</a><br><br>
                    ...
                    <table>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($gbr)): ?>
                            <tr>
                                <td>
                                    <img src="img/<?php echo $row["gambar"]; ?>" alt="aduh" style="width:500px" class="img-fluid">
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </table>
